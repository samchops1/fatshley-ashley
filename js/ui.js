...
(function (global) {
  ...
  function drawScoreHud(ctx, x, y, score, shots, handled) {
    ctx.fillStyle = '#ffddaa';
    ctx.font = '12px Courier New, monospace';
    ctx.textAlign = 'left';
    ctx.fillText('SCORE ' + score, x, y);
    ctx.fillText('SHOTS ' + shots + '  PPL ' + handled, x, y + 14);
  }
  ...
  function layoutPlayControls(W, H) {
    ...
    return {
      left: { x: margin, y: y, w: btnW, h: btnH, id: 'left' },
      right: { x: margin + btnW + 10, y: y, w: btnW, h: btnH, id: 'right' },
      drink: { x: W - drinkW - margin, y: y, w: drinkW, h: btnH, id: 'drink' },
  ...
  function drawTitleScreen(ctx, W, H, highScore, frame) {
    ...
    ctx.fillText('Vodka sweet spot. Survive till Last Call.', W / 2, 448);
    ...
    ctx.font = '10px Courier New, monospace';
    ctx.fillText('Arrows · DRINK · IGNORE / FLIRT / YELL', W / 2, 610);
